...
public class ClientIT {
	...
	public void findClient_WithClientTokenData_ReturnClientWithStatus200() {
		...
		org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
		org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("19913027039");
		org.assertj.core.api.Assertions.assertThat(responseBody.getName()).isEqualTo("Nando Reis");
		org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10);
	}
